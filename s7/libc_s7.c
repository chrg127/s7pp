...
static s7_pointer fsym, s7_F, s7_unspec, ffunc, c_pointer_string, string_string, character_string, boolean_string, real_string, complex_string, integer_string;
static s7_pointer struct_msghdr__symbol, const_struct_msghdr__symbol, const_struct_sockaddr__symbol, struct_addrinfo__symbol, protoent__symbol, servent__symbol, netent__symbol, hostent__symbol, struct_rlimit__symbol, sigset_t__symbol, glob_t__symbol, wordexp_t__symbol, passwd__symbol, tm__symbol, time_t__symbol, DIR__symbol, int__symbol, fpos_t__symbol, FILE__symbol, void__symbol, fenv_t__symbol, fexcept_t__symbol;
                  ...
                  static s7_pointer g_string_to_c_pointer(s7_scheme *sc, s7_pointer args)
                  {
                   if (s7_is_string(s7_car(args)))
                     return(s7_make_c_pointer_with_type(sc, (void *)s7_string(s7_car(args)), s7_make_symbol(sc, "void*"), s7_F));
                   return(s7_car(args));
                  }
...
static s7_pointer s7__isalnum(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isalnum)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isalpha(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isalpha)", 17), 0, arg, integer_string));
...
static s7_pointer s7__iscntrl(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'iscntrl)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isdigit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isdigit)", 17), 0, arg, integer_string));
...
static s7_pointer s7__islower(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'islower)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isgraph(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isgraph)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isprint(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isprint)", 17), 0, arg, integer_string));
...
static s7_pointer s7__ispunct(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'ispunct)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isspace(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isspace)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isupper(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isupper)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isxdigit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isxdigit)", 18), 0, arg, integer_string));
...
static s7_pointer s7__tolower(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tolower)", 17), 0, arg, integer_string));
...
static s7_pointer s7__toupper(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'toupper)", 17), 0, arg, integer_string));
...
static s7_pointer s7__fcntl(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fcntl)", 15), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__fcntl_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fcntl)", 15), 2, arg, integer_string));
...
static s7_pointer s7__creat(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'creat)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__creat_1 = (mode_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'creat)", 15), 2, arg, integer_string));
...
static s7_pointer s7__lockf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'lockf)", 15), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__lockf_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'lockf)", 15), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__lockf_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'lockf)", 15), 3, arg, integer_string));
...
static s7_pointer s7__feclearexcept(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'feclearexcept)", 23), 0, arg, integer_string));
...
static s7_pointer s7__fegetexceptflag(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fegetexceptflag)", 25), 2, arg, integer_string));
...
static s7_pointer s7__feraiseexcept(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'feraiseexcept)", 23), 0, arg, integer_string));
...
static s7_pointer s7__fesetexceptflag(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fesetexceptflag)", 25), 2, arg, integer_string));
...
static s7_pointer s7__fetestexcept(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fetestexcept)", 22), 0, arg, integer_string));
...
static s7_pointer s7__fesetround(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fesetround)", 20), 0, arg, integer_string));
...
static s7_pointer s7__feupdateenv(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_integer(sc, (s7_int)feupdateenv(s7__feupdateenv_0)));
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(fenv_t)), s7_make_symbol(sc, "fenv_t*"), s7_F));}
...
static s7_pointer s7__fnmatch(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fnmatch)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__fnmatch_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fnmatch)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__fnmatch_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fnmatch)", 17), 3, arg, integer_string));
...
static s7_pointer s7__memcpy(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'memcpy)", 16), 3, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)memcpy(s7__memcpy_0, s7__memcpy_1, s7__memcpy_2), void__symbol, s7_F));
}
...
static s7_pointer s7__memmove(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'memmove)", 17), 3, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)memmove(s7__memmove_0, s7__memmove_1, s7__memmove_2), void__symbol, s7_F));
}
...
static s7_pointer s7__memset(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'memset)", 16), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__memset_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'memset)", 16), 3, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)memset(s7__memset_0, s7__memset_1, s7__memset_2), void__symbol, s7_F));
}
...
static s7_pointer s7__memcmp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'memcmp)", 16), 3, arg, integer_string));
...
static s7_pointer s7__memchr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'memchr)", 16), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__memchr_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'memchr)", 16), 3, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)memchr(s7__memchr_0, s7__memchr_1, s7__memchr_2), void__symbol, s7_F));
}
...
static s7_pointer s7__strcpy(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcpy)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strcpy_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcpy)", 16), 2, arg, string_string));
...
static s7_pointer s7__strncpy(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncpy)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strncpy_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncpy)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strncpy_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncpy)", 17), 3, arg, integer_string));
...
static s7_pointer s7__strcat(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcat)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strcat_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcat)", 16), 2, arg, string_string));
...
static s7_pointer s7__strncat(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncat)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strncat_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncat)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strncat_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncat)", 17), 3, arg, integer_string));
...
static s7_pointer s7__strcmp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcmp)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strcmp_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcmp)", 16), 2, arg, string_string));
...
static s7_pointer s7__strncmp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncmp)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strncmp_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncmp)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strncmp_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncmp)", 17), 3, arg, integer_string));
...
static s7_pointer s7__strcoll(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcoll)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strcoll_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcoll)", 17), 2, arg, string_string));
...
static s7_pointer s7__strxfrm(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strxfrm)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strxfrm_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strxfrm)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strxfrm_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strxfrm)", 17), 3, arg, integer_string));
...
static s7_pointer s7__strchr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strchr)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strchr_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strchr)", 16), 2, arg, integer_string));
...
static s7_pointer s7__strrchr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strrchr)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strrchr_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strrchr)", 17), 2, arg, integer_string));
...
static s7_pointer s7__strcspn(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcspn)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strcspn_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcspn)", 17), 2, arg, string_string));
...
static s7_pointer s7__strspn(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strspn)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strspn_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strspn)", 16), 2, arg, string_string));
...
static s7_pointer s7__strpbrk(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strpbrk)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strpbrk_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strpbrk)", 17), 2, arg, string_string));
...
static s7_pointer s7__strstr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strstr)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strstr_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strstr)", 16), 2, arg, string_string));
...
static s7_pointer s7__strtok(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strtok)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strtok_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strtok)", 16), 2, arg, string_string));
...
static s7_pointer s7__strlen(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strlen)", 16), 0, arg, string_string));
  return(s7_make_integer(sc, (s7_int)strlen(s7__strlen_0)));
}


/* -------- strnlen -------- */
static s7_pointer s7__strnlen(s7_scheme *sc, s7_pointer args)
{
  s7_pointer p, arg;
  char* s7__strnlen_0;
  size_t s7__strnlen_1;
  p = args;
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strnlen_0 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strnlen)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strnlen_1 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strnlen)", 17), 2, arg, integer_string));
  return(s7_make_integer(sc, (s7_int)strnlen(s7__strnlen_0, s7__strnlen_1)));
}
...
static s7_pointer s7__strerror(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strerror)", 18), 0, arg, integer_string));
...
static s7_pointer s7__strcasecmp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcasecmp)", 20), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strcasecmp_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strcasecmp)", 20), 2, arg, string_string));
...
static s7_pointer s7__strncasecmp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncasecmp)", 21), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__strncasecmp_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncasecmp)", 21), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__strncasecmp_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'strncasecmp)", 21), 3, arg, integer_string));
...
static s7_pointer s7__remove(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'remove)", 16), 0, arg, string_string));
...
static s7_pointer s7__rename(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'rename)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__rename_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'rename)", 16), 2, arg, string_string));
...
{
  return(s7_make_c_pointer_with_type(sc, (void*)tmpfile(), FILE__symbol, s7_F));
}
...
static s7_pointer s7__fopen(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fopen)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__fopen_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fopen)", 15), 2, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)fopen(s7__fopen_0, s7__fopen_1), FILE__symbol, s7_F));
}
...
static s7_pointer s7__freopen(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'freopen)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__freopen_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'freopen)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  s7__freopen_2 = (FILE*)s7_c_pointer_with_type(sc, arg, FILE__symbol, __func__, 3);
  return(s7_make_c_pointer_with_type(sc, (void*)freopen(s7__freopen_0, s7__freopen_1, s7__freopen_2), FILE__symbol, s7_F));
}
...
static s7_pointer s7__fdopen(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fdopen)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__fdopen_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fdopen)", 16), 2, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)fdopen(s7__fdopen_0, s7__fdopen_1), FILE__symbol, s7_F));
}
...
static s7_pointer s7__setbuf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setbuf)", 16), 2, arg, string_string));
...
static s7_pointer s7__setvbuf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setvbuf)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__setvbuf_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setvbuf)", 17), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__setvbuf_3 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setvbuf)", 17), 4, arg, integer_string));
...
static s7_pointer s7__fputc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fputc)", 15), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__putc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'putc)", 14), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__putchar(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'putchar)", 17), 0, arg, integer_string));
...
static s7_pointer s7__fgets(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fgets)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__fgets_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fgets)", 15), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__fputs(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fputs)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__puts(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'puts)", 14), 0, arg, string_string));
...
static s7_pointer s7__ungetc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'ungetc)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__fread(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fread)", 15), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__fread_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fread)", 15), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__fwrite(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fwrite)", 16), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__fwrite_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fwrite)", 16), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__fseek(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fseek)", 15), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__fseek_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fseek)", 15), 3, arg, integer_string));
...
static s7_pointer s7__perror(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'perror)", 16), 0, arg, string_string));
  perror(s7__perror_0);
  return(s7_unspec);
}
...
static s7_pointer s7__popen(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'popen)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__popen_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'popen)", 15), 2, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)popen(s7__popen_0, s7__popen_1), FILE__symbol, s7_F));
}
...
static s7_pointer s7__ctermid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'ctermid)", 17), 0, arg, string_string));
...
static s7_pointer s7__atof(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'atof)", 14), 0, arg, string_string));
...
static s7_pointer s7__atoi(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'atoi)", 14), 0, arg, string_string));
...
static s7_pointer s7__atol(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'atol)", 14), 0, arg, string_string));
...
static s7_pointer s7__atoll(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'atoll)", 15), 0, arg, string_string));
...
static s7_pointer s7__srandom(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'srandom)", 17), 0, arg, integer_string));
...
static s7_pointer s7__initstate(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'initstate)", 19), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__initstate_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'initstate)", 19), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__initstate_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'initstate)", 19), 3, arg, integer_string));
...
static s7_pointer s7__setstate(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setstate)", 18), 0, arg, string_string));
...
static s7_pointer s7__srand(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'srand)", 15), 0, arg, integer_string));
  srand(s7__srand_0);
  return(s7_unspec);
}
...
static s7_pointer s7__malloc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'malloc)", 16), 0, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)malloc(s7__malloc_0), void__symbol, s7_F));
}
...
static s7_pointer s7__calloc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'calloc)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__calloc_1 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'calloc)", 16), 2, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)calloc(s7__calloc_0, s7__calloc_1), void__symbol, s7_F));
}
...
static s7_pointer s7__realloc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'realloc)", 17), 2, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)realloc(s7__realloc_0, s7__realloc_1), void__symbol, s7_F));
}
...
static s7_pointer s7__exit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'exit)", 14), 0, arg, integer_string));
  exit(s7__exit_0);
  return(s7_unspec);
}
...
static s7_pointer s7__getenv(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getenv)", 16), 0, arg, string_string));
...
static s7_pointer s7__putenv(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'putenv)", 16), 0, arg, string_string));
...
static s7_pointer s7__setenv(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setenv)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__setenv_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setenv)", 16), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__setenv_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setenv)", 16), 3, arg, integer_string));
...
static s7_pointer s7__unsetenv(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'unsetenv)", 18), 0, arg, string_string));
...
static s7_pointer s7__mkstemp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mkstemp)", 17), 0, arg, string_string));
...
static s7_pointer s7__system(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'system)", 16), 0, arg, string_string));
...
static s7_pointer s7__abs(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'abs)", 13), 0, arg, integer_string));
...
static s7_pointer s7__labs(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'labs)", 14), 0, arg, integer_string));
...
static s7_pointer s7__setlocale(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setlocale)", 19), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__setlocale_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setlocale)", 19), 2, arg, string_string));
...
static s7_pointer s7__access(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'access)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__access_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'access)", 16), 2, arg, integer_string));
...
static s7_pointer s7__lseek(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'lseek)", 15), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__lseek_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'lseek)", 15), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__lseek_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'lseek)", 15), 3, arg, integer_string));
...
static s7_pointer s7__close(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'close)", 15), 0, arg, integer_string));
...
static s7_pointer s7__read(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'read)", 14), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'read)", 14), 3, arg, integer_string));
...
static s7_pointer s7__write(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'write)", 15), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'write)", 15), 3, arg, integer_string));
...
static s7_pointer s7__pread(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pread)", 15), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pread)", 15), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__pread_3 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pread)", 15), 4, arg, integer_string));
...
static s7_pointer s7__pwrite(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pwrite)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pwrite)", 16), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__pwrite_3 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pwrite)", 16), 4, arg, integer_string));
...
static s7_pointer s7__alarm(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'alarm)", 15), 0, arg, integer_string));
...
static s7_pointer s7__sleep(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sleep)", 15), 0, arg, integer_string));
...
static s7_pointer s7__chown(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'chown)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__chown_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'chown)", 15), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__chown_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'chown)", 15), 3, arg, integer_string));
...
static s7_pointer s7__chdir(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'chdir)", 15), 0, arg, string_string));
...
static s7_pointer s7__getcwd(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getcwd)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__getcwd_1 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getcwd)", 16), 2, arg, integer_string));
...
static s7_pointer s7__dup(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'dup)", 13), 0, arg, integer_string));
...
static s7_pointer s7__dup2(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'dup2)", 14), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__dup2_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'dup2)", 14), 2, arg, integer_string));
...
static s7_pointer s7___exit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* '_exit)", 15), 0, arg, integer_string));
  _exit(s7___exit_0);
  return(s7_unspec);
}
...
static s7_pointer s7__pathconf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pathconf)", 18), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__pathconf_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'pathconf)", 18), 2, arg, integer_string));
...
static s7_pointer s7__fpathconf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fpathconf)", 19), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__fpathconf_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'fpathconf)", 19), 2, arg, integer_string));
...
static s7_pointer s7__sysconf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sysconf)", 17), 0, arg, integer_string));
...
static s7_pointer s7__confstr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'confstr)", 17), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__confstr_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'confstr)", 17), 2, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__confstr_2 = (size_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'confstr)", 17), 3, arg, integer_string));
...
static s7_pointer s7__getpgid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getpgid)", 17), 0, arg, integer_string));
...
static s7_pointer s7__setpgid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setpgid)", 17), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__setpgid_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setpgid)", 17), 2, arg, integer_string));
...
static s7_pointer s7__getsid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getsid)", 16), 0, arg, integer_string));
...
static s7_pointer s7__setuid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setuid)", 16), 0, arg, integer_string));
...
static s7_pointer s7__setgid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setgid)", 16), 0, arg, integer_string));
...
static s7_pointer s7__ttyname(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'ttyname)", 17), 0, arg, integer_string));
...
static s7_pointer s7__isatty(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'isatty)", 16), 0, arg, integer_string));
...
static s7_pointer s7__link(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'link)", 14), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__link_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'link)", 14), 2, arg, string_string));
...
static s7_pointer s7__unlink(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'unlink)", 16), 0, arg, string_string));
...
static s7_pointer s7__rmdir(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'rmdir)", 15), 0, arg, string_string));
...
static s7_pointer s7__tcgetpgrp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcgetpgrp)", 19), 0, arg, integer_string));
...
static s7_pointer s7__tcsetpgrp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcsetpgrp)", 19), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__tcsetpgrp_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcsetpgrp)", 19), 2, arg, integer_string));
...
static s7_pointer s7__truncate(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'truncate)", 18), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__truncate_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'truncate)", 18), 2, arg, integer_string));
...
static s7_pointer s7__ftruncate(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'ftruncate)", 19), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__ftruncate_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'ftruncate)", 19), 2, arg, integer_string));
...
static s7_pointer s7__opendir(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'opendir)", 17), 0, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)opendir(s7__opendir_0), DIR__symbol, s7_F));
}
...
static s7_pointer s7__chmod(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'chmod)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__chmod_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'chmod)", 15), 2, arg, integer_string));
...
static s7_pointer s7__mkdir(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mkdir)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__mkdir_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mkdir)", 15), 2, arg, integer_string));
...
static s7_pointer s7__mknod(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mknod)", 15), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__mknod_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mknod)", 15), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__mknod_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mknod)", 15), 3, arg, integer_string));
...
static s7_pointer s7__mkfifo(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mkfifo)", 16), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__mkfifo_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'mkfifo)", 16), 2, arg, integer_string));
  return(s7_make_integer(sc, (s7_int)mkfifo(s7__mkfifo_0, s7__mkfifo_1)));
                  ...
                  static s7_pointer g_stat_make(s7_scheme *sc, s7_pointer args)
                    {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(struct stat)), s7_make_symbol(sc, "stat*"), s7_F));}
                  static s7_pointer g_stat_free(s7_scheme *sc, s7_pointer args) {free(s7_c_pointer(s7_car(args))); return(s7_F);}
...
static s7_pointer s7__difftime(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'difftime)", 18), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__difftime_1 = (time_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'difftime)", 18), 2, arg, integer_string));
...
static s7_pointer s7__gmtime(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer_with_type(sc, (void*)gmtime(s7__gmtime_0), tm__symbol, s7_F));
}
...
static s7_pointer s7__localtime(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer_with_type(sc, (void*)localtime(s7__localtime_0), tm__symbol, s7_F));
}
                  ...
                  static s7_pointer g_time_make(s7_scheme *sc, s7_pointer args)
                  {
                    ...
                    return(s7_make_c_pointer_with_type(sc, (void *)tm, s7_make_symbol(sc, "time_t*"), s7_F));
                  }
                  static s7_pointer g_time_free(s7_scheme *sc, s7_pointer args) {free(s7_c_pointer(s7_car(args))); return(s7_F);}
...
static s7_pointer s7__tcsendbreak(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcsendbreak)", 21), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__tcsendbreak_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcsendbreak)", 21), 2, arg, integer_string));
...
static s7_pointer s7__tcdrain(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcdrain)", 17), 0, arg, integer_string));
...
static s7_pointer s7__tcflush(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcflush)", 17), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__tcflush_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcflush)", 17), 2, arg, integer_string));
...
static s7_pointer s7__tcflow(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcflow)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__tcflow_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'tcflow)", 16), 2, arg, integer_string));
...
static s7_int tcflow_i_ii(s7_int i1, s7_int i2) {return(tcflow(i1, i2));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(struct termios)), s7_make_symbol(sc, "termios*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, getgrgid(s7_integer(s7_car(args))), s7_make_symbol(sc, "group*"), s7_F));}
                  static s7_pointer g_getgrnam(s7_scheme *sc, s7_pointer args)
                  {return(s7_make_c_pointer_with_type(sc, getgrnam(s7_string(s7_car(args))), s7_make_symbol(sc, "group*"), s7_F));}
...
{
  return(s7_make_c_pointer_with_type(sc, (void*)getpwent(), passwd__symbol, s7_F));
}
...
static s7_pointer s7__getpwuid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getpwuid)", 18), 0, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getpwuid(s7__getpwuid_0), passwd__symbol, s7_F));
}
...
static s7_pointer s7__getpwnam(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getpwnam)", 18), 0, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getpwnam(s7__getpwnam_0), passwd__symbol, s7_F));
}
...
static s7_pointer s7__wordexp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'wordexp)", 17), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'wordexp)", 17), 3, arg, integer_string));
...
static s7_pointer s7__wordfree(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_unspec);
                  ...
                  static s7_pointer g_wordexp_free(s7_scheme *sc, s7_pointer args) {free(s7_c_pointer(s7_car(args))); return(s7_F);}
                  static s7_pointer g_wordexp_make(s7_scheme *sc, s7_pointer args)
                           {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(wordexp_t)), s7_make_symbol(sc, "wordexp_t*"), s7_F));}
...
static s7_pointer s7__globfree(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_unspec);
                  ...
                  static s7_pointer g_glob_make(s7_scheme *sc, s7_pointer args)
                           {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(glob_t)), s7_make_symbol(sc, "glob_t*"), s7_F));}
...
static s7_pointer s7__kill(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'kill)", 14), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__kill_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'kill)", 14), 2, arg, integer_string));
...
static s7_pointer s7__raise(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'raise)", 15), 0, arg, integer_string));
...
static s7_pointer s7__sigaddset(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sigaddset)", 19), 2, arg, integer_string));
...
static s7_pointer s7__sigdelset(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sigdelset)", 19), 2, arg, integer_string));
...
static s7_pointer s7__sigismember(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sigismember)", 21), 2, arg, integer_string));
...
static s7_pointer s7__sigprocmask(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sigprocmask)", 21), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__getpriority(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getpriority)", 21), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__getpriority_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getpriority)", 21), 2, arg, integer_string));
...
static s7_pointer s7__setpriority(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setpriority)", 21), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__setpriority_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setpriority)", 21), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__setpriority_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setpriority)", 21), 3, arg, integer_string));
  return(s7_make_integer(sc, (s7_int)setpriority(s7__setpriority_0, s7__setpriority_1, s7__setpriority_2)));
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(struct rlimit)), s7_make_symbol(sc, "rlimit*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(struct rusage)), s7_make_symbol(sc, "rusage*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(sigset_t)), s7_make_symbol(sc, "sigset_t*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(siginfo_t)), s7_make_symbol(sc, "siginfo_t*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc,
                            ...
                            s7_make_symbol(sc, "siginfo_t*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(struct timespec)), s7_make_symbol(sc, "timespec*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(struct sigaction)), s7_make_symbol(sc, "sigaction*"), s7_F));}
                  ...
                  {return(s7_make_c_pointer_with_type(sc, (void *)(&(((struct sigaction *)s7_c_pointer_with_type(sc, s7_car(args), s7_make_symbol(sc, "sigaction*"), __func__, 1))->sa_mask)), s7_make_symbol(sc, "sigset_t*"), s7_F));}
...
static s7_pointer s7__getrlimit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getrlimit)", 19), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
static s7_pointer s7__setrlimit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setrlimit)", 19), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
...
{
  return(s7_make_c_pointer_with_type(sc, (void*)gethostent(), hostent__symbol, s7_F));
}
...
static s7_pointer s7__setnetent(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setnetent)", 19), 0, arg, integer_string));
...
{
  return(s7_make_c_pointer_with_type(sc, (void*)getnetent(), netent__symbol, s7_F));
}
...
static s7_pointer s7__getnetbyname(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getnetbyname)", 22), 0, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getnetbyname(s7__getnetbyname_0), netent__symbol, s7_F));
}
...
static s7_pointer s7__getnetbyaddr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getnetbyaddr)", 22), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__getnetbyaddr_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getnetbyaddr)", 22), 2, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getnetbyaddr(s7__getnetbyaddr_0, s7__getnetbyaddr_1), netent__symbol, s7_F));
}
...
static s7_pointer s7__sethostent(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sethostent)", 20), 0, arg, integer_string));
...
static s7_pointer s7__setservent(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setservent)", 20), 0, arg, integer_string));
...
{
  return(s7_make_c_pointer_with_type(sc, (void*)getservent(), servent__symbol, s7_F));
}
...
static s7_pointer s7__setprotoent(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'setprotoent)", 21), 0, arg, integer_string));
...
{
  return(s7_make_c_pointer_with_type(sc, (void*)getprotoent(), protoent__symbol, s7_F));
}
...
static s7_pointer s7__socket(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'socket)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__socket_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'socket)", 16), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__socket_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'socket)", 16), 3, arg, integer_string));
...
static s7_pointer s7__listen(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'listen)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__listen_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'listen)", 16), 2, arg, integer_string));
...
static s7_pointer s7__shutdown(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'shutdown)", 18), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__shutdown_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'shutdown)", 18), 2, arg, integer_string));
...
static s7_pointer s7__gethostbyname(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'gethostbyname)", 23), 0, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)gethostbyname(s7__gethostbyname_0), hostent__symbol, s7_F));
}
...
static s7_pointer s7__gethostbyaddr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'gethostbyaddr)", 23), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__gethostbyaddr_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'gethostbyaddr)", 23), 3, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)gethostbyaddr(s7__gethostbyaddr_0, s7__gethostbyaddr_1, s7__gethostbyaddr_2), hostent__symbol, s7_F));
}
...
static s7_pointer s7__getservbyname(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getservbyname)", 23), 1, arg, string_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__getservbyname_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getservbyname)", 23), 2, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getservbyname(s7__getservbyname_0, s7__getservbyname_1), servent__symbol, s7_F));
}
...
static s7_pointer s7__getservbyport(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getservbyport)", 23), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_string(arg))
    s7__getservbyport_1 = (char*)s7_string(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getservbyport)", 23), 2, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getservbyport(s7__getservbyport_0, s7__getservbyport_1), servent__symbol, s7_F));
}
...
static s7_pointer s7__getprotobyname(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getprotobyname)", 24), 0, arg, string_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getprotobyname(s7__getprotobyname_0), protoent__symbol, s7_F));
}
...
static s7_pointer s7__getprotobynumber(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'getprotobynumber)", 26), 0, arg, integer_string));
  return(s7_make_c_pointer_with_type(sc, (void*)getprotobynumber(s7__getprotobynumber_0), protoent__symbol, s7_F));
}
...
static s7_pointer s7__gai_strerror(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'gai_strerror)", 22), 0, arg, integer_string));
...
static s7_pointer s7__bind(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'bind)", 14), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'bind)", 14), 3, arg, integer_string));
...
static s7_pointer s7__connect(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'connect)", 17), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'connect)", 17), 3, arg, integer_string));
...
static s7_pointer s7__send(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'send)", 14), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'send)", 14), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__send_3 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'send)", 14), 4, arg, integer_string));
...
static s7_pointer s7__recv(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'recv)", 14), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'recv)", 14), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__recv_3 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'recv)", 14), 4, arg, integer_string));
...
static s7_pointer s7__sendto(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sendto)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sendto)", 16), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__sendto_3 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sendto)", 16), 4, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sendto)", 16), 6, arg, integer_string));
...
static s7_pointer s7__sendmsg(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sendmsg)", 17), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'sendmsg)", 17), 3, arg, integer_string));
...
static s7_pointer s7__recvmsg(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'recvmsg)", 17), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  ...
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'recvmsg)", 17), 3, arg, integer_string));
  return(s7_make_integer(sc, (s7_int)recvmsg(s7__recvmsg_0, s7__recvmsg_1, s7__recvmsg_2)));
                  ...
                  {
                    return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(struct addrinfo)), s7_make_symbol(sc, "addrinfo*"), s7_F));
                  }
                  ...
                  {
                    return(s7_make_c_pointer_with_type(sc, (void *)(((struct addrinfo *)s7_c_pointer_with_type(sc, s7_car(args), s7_make_symbol(sc, "addrinfo*"), __func__, 1))->ai_next), s7_make_symbol(sc, "addrinfo*"), s7_F));
                  }
                  ...
                  static s7_pointer g_getaddrinfo(s7_scheme *sc, s7_pointer args)
                  {
                    ...
                    return(s7_list(sc, 2, s7_make_integer(sc, err),
                                          s7_make_c_pointer_with_type(sc, (void *)result, s7_make_symbol(sc, "addrinfo*"), s7_F)));
                  }
                  ...
                  {
                    return(s7_make_c_pointer_with_type(sc, (void *)calloc(1, sizeof(regex_t)), s7_make_symbol(sc, "regex_t*"), s7_F));
                  }
...
{
  s7_pointer cur_env;
  s7_pointer pcl_t, pl_tx, pl_ts, pl_ti, pl_txs, pcl_i, pl_ix, pl_it, pcl_is, pl_is, pcl_ix, pcl_iix, pcl_isi, pl_ixi, pl_isi, pl_iix, pl_isx, pcl_ixi, pl_isxi, pl_iisi, pcl_iixi, pl_iixi, pl_issi, pl_ixxi, pcl_ixsi, pl_ixiix, pl_iixiixi, pcl_di, pl_ds, pcl_s, pl_sx, pl_st, pl_si, pl_sis, pl_ssi, pl_sssi, pl_ssix, pl_sisi, pcl_x, pl_xs, pcl_xi, pl_xi, pl_xt, pcl_xs, pl_xxi, pcl_xxi, pl_xis, pl_xxxi, pl_xssx;
  {
  ...
  s7_define(sc, cur_env, s7_make_symbol(sc, "SIG_IGN"), s7_make_c_pointer_with_type(sc, (void*)SIG_IGN, s7_make_symbol(sc, "void*"), s7_F));
  s7_define(sc, cur_env, s7_make_symbol(sc, "SIG_DFL"), s7_make_c_pointer_with_type(sc, (void*)SIG_DFL, s7_make_symbol(sc, "void*"), s7_F));
  s7_define(sc, cur_env, s7_make_symbol(sc, "SIG_ERR"), s7_make_c_pointer_with_type(sc, (void*)SIG_ERR, s7_make_symbol(sc, "void*"), s7_F));
  ...
  s7_define(sc, cur_env, s7_make_symbol(sc, "stderr"), s7_make_c_pointer_with_type(sc, (void*)stderr, s7_make_symbol(sc, "FILE*"), s7_F));
  s7_define(sc, cur_env, s7_make_symbol(sc, "stdout"), s7_make_c_pointer_with_type(sc, (void*)stdout, s7_make_symbol(sc, "FILE*"), s7_F));
  s7_define(sc, cur_env, s7_make_symbol(sc, "stdin"), s7_make_c_pointer_with_type(sc, (void*)stdin, s7_make_symbol(sc, "FILE*"), s7_F));
  ...
  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "regerror"),
            ffunc = s7_make_typed_function_with_environment(sc, "regerror", g_regerror, 2, 0, false, "regerror", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "regexec"),
            ffunc = s7_make_typed_function_with_environment(sc, "regexec", g_regexec, 4, 0, false, "regexec", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "regcomp"),
            ffunc = s7_make_typed_function_with_environment(sc, "regcomp", g_regcomp, 3, 0, false, "regcomp", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "regfree"),
            ffunc = s7_make_typed_function_with_environment(sc, "regfree", g_regfree, 1, 0, false, "regfree", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "regex.free"),
            ffunc = s7_make_typed_function_with_environment(sc, "regex.free", g_regex_free, 1, 0, false, "regex.free", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "regex.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "regex.make", g_regex_make, 0, 0, false, "regex.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "recvfrom"),
            ffunc = s7_make_typed_function_with_environment(sc, "recvfrom", g_recvfrom, 6, 0, false, "recvfrom", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setsockopt"),
            ffunc = s7_make_typed_function_with_environment(sc, "setsockopt", g_setsockopt, 5, 0, false, "setsockopt", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getsockopt"),
            ffunc = s7_make_typed_function_with_environment(sc, "getsockopt", g_getsockopt, 5, 0, false, "getsockopt", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "accept"),
            ffunc = s7_make_typed_function_with_environment(sc, "accept", g_accept, 3, 0, false, "accept", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getpeername"),
            ffunc = s7_make_typed_function_with_environment(sc, "getpeername", g_getpeername, 3, 0, false, "getpeername", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getsockname"),
            ffunc = s7_make_typed_function_with_environment(sc, "getsockname", g_getsockname, 3, 0, false, "getsockname", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "socketpair"),
            ffunc = s7_make_typed_function_with_environment(sc, "socketpair", g_socketpair, 3, 0, false, "socketpair", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "protoent.p_aliases"),
            ffunc = s7_make_typed_function_with_environment(sc, "protoent.p_aliases", g_protoent_p_aliases, 1, 0, false, "protoent.p_aliases", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "netent.n_aliases"),
            ffunc = s7_make_typed_function_with_environment(sc, "netent.n_aliases", g_netent_n_aliases, 1, 0, false, "netent.n_aliases", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "servent.s_aliases"),
            ffunc = s7_make_typed_function_with_environment(sc, "servent.s_aliases", g_servent_s_aliases, 1, 0, false, "servent.s_aliases", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "hostent.h_aliases"),
            ffunc = s7_make_typed_function_with_environment(sc, "hostent.h_aliases", g_hostent_h_aliases, 1, 0, false, "hostent.h_aliases", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "protoent.p_proto"),
            ffunc = s7_make_typed_function_with_environment(sc, "protoent.p_proto", g_protoent_p_proto, 1, 0, false, "protoent.p_proto", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "servent.s_port"),
            ffunc = s7_make_typed_function_with_environment(sc, "servent.s_port", g_servent_s_port, 1, 0, false, "servent.s_port", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "netent.n_net"),
            ffunc = s7_make_typed_function_with_environment(sc, "netent.n_net", g_netent_n_net, 1, 0, false, "netent.n_net", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "netent.n_addrtype"),
            ffunc = s7_make_typed_function_with_environment(sc, "netent.n_addrtype", g_netent_n_addrtype, 1, 0, false, "netent.n_addrtype", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "hostent.h_length"),
            ffunc = s7_make_typed_function_with_environment(sc, "hostent.h_length", g_hostent_h_length, 1, 0, false, "hostent.h_length", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "hostent.h_addrtype"),
            ffunc = s7_make_typed_function_with_environment(sc, "hostent.h_addrtype", g_hostent_h_addrtype, 1, 0, false, "hostent.h_addrtype", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "protoent.p_name"),
            ffunc = s7_make_typed_function_with_environment(sc, "protoent.p_name", g_protoent_p_name, 1, 0, false, "protoent.p_name", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "servent.s_proto"),
            ffunc = s7_make_typed_function_with_environment(sc, "servent.s_proto", g_servent_s_proto, 1, 0, false, "servent.s_proto", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "servent.s_name"),
            ffunc = s7_make_typed_function_with_environment(sc, "servent.s_name", g_servent_s_name, 1, 0, false, "servent.s_name", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "netent.n_name"),
            ffunc = s7_make_typed_function_with_environment(sc, "netent.n_name", g_netent_n_name, 1, 0, false, "netent.n_name", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "hostent.h_name"),
            ffunc = s7_make_typed_function_with_environment(sc, "hostent.h_name", g_hostent_h_name, 1, 0, false, "hostent.h_name", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.ai_next"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.ai_next", g_addrinfo_ai_next, 1, 0, false, "addrinfo.ai_next", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.ai_canonname"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.ai_canonname", g_addrinfo_ai_canonname, 1, 0, false, "addrinfo.ai_canonname", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.set_ai_protocol"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.set_ai_protocol", g_addrinfo_set_ai_protocol, 2, 0, false, "addrinfo.set_ai_protocol", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.ai_protocol"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.ai_protocol", g_addrinfo_ai_protocol, 1, 0, false, "addrinfo.ai_protocol", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.set_ai_socktype"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.set_ai_socktype", g_addrinfo_set_ai_socktype, 2, 0, false, "addrinfo.set_ai_socktype", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.ai_socktype"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.ai_socktype", g_addrinfo_ai_socktype, 1, 0, false, "addrinfo.ai_socktype", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.set_ai_family"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.set_ai_family", g_addrinfo_set_ai_family, 2, 0, false, "addrinfo.set_ai_family", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.ai_family"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.ai_family", g_addrinfo_ai_family, 1, 0, false, "addrinfo.ai_family", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.set_ai_flags"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.set_ai_flags", g_addrinfo_set_ai_flags, 2, 0, false, "addrinfo.set_ai_flags", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.ai_flags"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.ai_flags", g_addrinfo_ai_flags, 1, 0, false, "addrinfo.ai_flags", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "addrinfo.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "addrinfo.make", g_addrinfo_make, 0, 0, false, "addrinfo.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getnameinfo"),
            ffunc = s7_make_typed_function_with_environment(sc, "getnameinfo", g_getnameinfo, 3, 0, false, "getnameinfo", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getaddrinfo"),
            ffunc = s7_make_typed_function_with_environment(sc, "getaddrinfo", g_getaddrinfo, 3, 0, false, "getaddrinfo", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ntohs"),
            ffunc = s7_make_typed_function_with_environment(sc, "ntohs", g_ntohs, 1, 0, false, "ntohs", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ntohl"),
            ffunc = s7_make_typed_function_with_environment(sc, "ntohl", g_ntohl, 1, 0, false, "ntohl", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "htons"),
            ffunc = s7_make_typed_function_with_environment(sc, "htons", g_htons, 1, 0, false, "htons", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "htonl"),
            ffunc = s7_make_typed_function_with_environment(sc, "htonl", g_htonl, 1, 0, false, "htonl", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "recvmsg"),
            ffunc = s7_make_typed_function_with_environment(sc, "recvmsg", s7__recvmsg, 3, 0, false, "int recvmsg(int struct-msghdr* int)", pl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sendmsg"),
            ffunc = s7_make_typed_function_with_environment(sc, "sendmsg", s7__sendmsg, 3, 0, false, "int sendmsg(int const-struct-msghdr* int)", pl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sendto"),
            ffunc = s7_make_typed_function_with_environment(sc, "sendto", s7__sendto, 6, 0, false, "int sendto(int void* int int const-struct-sockaddr* int)", pl_iixiixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "recv"),
            ffunc = s7_make_typed_function_with_environment(sc, "recv", s7__recv, 4, 0, false, "int recv(int void* int int)", pcl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "send"),
            ffunc = s7_make_typed_function_with_environment(sc, "send", s7__send, 4, 0, false, "int send(int void* int int)", pcl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "connect"),
            ffunc = s7_make_typed_function_with_environment(sc, "connect", s7__connect, 3, 0, false, "int connect(int const-struct-sockaddr* int)", pl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "bind"),
            ffunc = s7_make_typed_function_with_environment(sc, "bind", s7__bind, 3, 0, false, "int bind(int const-struct-sockaddr* int)", pl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "gai_strerror"),
            ffunc = s7_make_typed_function_with_environment(sc, "gai_strerror", s7__gai_strerror, 1, 0, false, "char* gai_strerror(int)", pl_si, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "freeaddrinfo"),
            ffunc = s7_make_typed_function_with_environment(sc, "freeaddrinfo", s7__freeaddrinfo, 1, 0, false, "void freeaddrinfo(struct-addrinfo*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getprotobynumber"),
            ffunc = s7_make_typed_function_with_environment(sc, "getprotobynumber", s7__getprotobynumber, 1, 0, false, "protoent* getprotobynumber(int)", pl_xi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getprotobyname"),
            ffunc = s7_make_typed_function_with_environment(sc, "getprotobyname", s7__getprotobyname, 1, 0, false, "protoent* getprotobyname(char*)", pl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getservbyport"),
            ffunc = s7_make_typed_function_with_environment(sc, "getservbyport", s7__getservbyport, 2, 0, false, "servent* getservbyport(int char*)", pl_xis, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getservbyname"),
            ffunc = s7_make_typed_function_with_environment(sc, "getservbyname", s7__getservbyname, 2, 0, false, "servent* getservbyname(char* char*)", pcl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "gethostbyaddr"),
            ffunc = s7_make_typed_function_with_environment(sc, "gethostbyaddr", s7__gethostbyaddr, 3, 0, false, "hostent* gethostbyaddr(void* int int)", pcl_xxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "gethostbyname"),
            ffunc = s7_make_typed_function_with_environment(sc, "gethostbyname", s7__gethostbyname, 1, 0, false, "hostent* gethostbyname(char*)", pl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "shutdown"),
            ffunc = s7_make_typed_function_with_environment(sc, "shutdown", s7__shutdown, 2, 0, false, "int shutdown(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "listen"),
            ffunc = s7_make_typed_function_with_environment(sc, "listen", s7__listen, 2, 0, false, "int listen(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "socket"),
            ffunc = s7_make_typed_function_with_environment(sc, "socket", s7__socket, 3, 0, false, "int socket(int int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getprotoent"),
            ffunc = s7_make_typed_function_with_environment(sc, "getprotoent", s7__getprotoent, 0, 0, false, "protoent* getprotoent(void)", pl_xt, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "endprotoent"),
            ffunc = s7_make_typed_function_with_environment(sc, "endprotoent", s7__endprotoent, 0, 0, false, "void endprotoent(void)", pcl_t, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setprotoent"),
            ffunc = s7_make_typed_function_with_environment(sc, "setprotoent", s7__setprotoent, 1, 0, false, "void setprotoent(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getservent"),
            ffunc = s7_make_typed_function_with_environment(sc, "getservent", s7__getservent, 0, 0, false, "servent* getservent(void)", pl_xt, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "endservent"),
            ffunc = s7_make_typed_function_with_environment(sc, "endservent", s7__endservent, 0, 0, false, "void endservent(void)", pcl_t, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setservent"),
            ffunc = s7_make_typed_function_with_environment(sc, "setservent", s7__setservent, 1, 0, false, "void setservent(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "endhostent"),
            ffunc = s7_make_typed_function_with_environment(sc, "endhostent", s7__endhostent, 0, 0, false, "void endhostent(void)", pcl_t, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sethostent"),
            ffunc = s7_make_typed_function_with_environment(sc, "sethostent", s7__sethostent, 1, 0, false, "void sethostent(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getnetbyaddr"),
            ffunc = s7_make_typed_function_with_environment(sc, "getnetbyaddr", s7__getnetbyaddr, 2, 0, false, "netent* getnetbyaddr(int int)", pcl_xi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getnetbyname"),
            ffunc = s7_make_typed_function_with_environment(sc, "getnetbyname", s7__getnetbyname, 1, 0, false, "netent* getnetbyname(char*)", pl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getnetent"),
            ffunc = s7_make_typed_function_with_environment(sc, "getnetent", s7__getnetent, 0, 0, false, "netent* getnetent(void)", pl_xt, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "endnetent"),
            ffunc = s7_make_typed_function_with_environment(sc, "endnetent", s7__endnetent, 0, 0, false, "void endnetent(void)", pcl_t, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setnetent"),
            ffunc = s7_make_typed_function_with_environment(sc, "setnetent", s7__setnetent, 1, 0, false, "void setnetent(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "gethostent"),
            ffunc = s7_make_typed_function_with_environment(sc, "gethostent", s7__gethostent, 0, 0, false, "hostent* gethostent(void)", pl_xt, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setrlimit"),
            ffunc = s7_make_typed_function_with_environment(sc, "setrlimit", s7__setrlimit, 2, 0, false, "int setrlimit(int struct-rlimit*)", pl_iix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getrlimit"),
            ffunc = s7_make_typed_function_with_environment(sc, "getrlimit", s7__getrlimit, 2, 0, false, "int getrlimit(int struct-rlimit*)", pl_iix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "signal"),
            ffunc = s7_make_typed_function_with_environment(sc, "signal", g_signal, 2, 0, false, "signal", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigset.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigset.make", g_sigset_make, 0, 0, false, "sigset.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigtimedwait"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigtimedwait", g_sigtimedwait, 3, 0, false, "sigtimedwait", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaction"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaction", g_sigaction, 3, 0, false, "sigaction", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigwait"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigwait", g_sigwait, 1, 0, false, "sigwait", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigqueue"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigqueue", g_sigqueue, 3, 0, false, "sigqueue", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "waitpid"),
            ffunc = s7_make_typed_function_with_environment(sc, "waitpid", g_waitpid, 2, 0, false, "waitpid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "wait"),
            ffunc = s7_make_typed_function_with_environment(sc, "wait", g_wait, 0, 0, false, "wait", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaction.set_sa_flags"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaction.set_sa_flags", g_sigaction_set_sa_flags, 2, 0, false, "sigaction.set_sa_flags", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaction.set_sa_handler"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaction.set_sa_handler", g_sigaction_set_sa_handler, 2, 0, false, "sigaction.set_sa_handler", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaction.sa_mask"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaction.sa_mask", g_sigaction_sa_mask, 1, 0, false, "sigaction.sa_mask", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaction.sa_flags"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaction.sa_flags", g_sigaction_sa_flags, 1, 0, false, "sigaction.sa_flags", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaction.sa_handler"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaction.sa_handler", g_sigaction_sa_handler, 1, 0, false, "sigaction.sa_handler", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaction.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaction.make", g_sigaction_make, 0, 0, false, "sigaction.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "timespec.tv_nsec"),
            ffunc = s7_make_typed_function_with_environment(sc, "timespec.tv_nsec", g_timespec_tv_nsec, 1, 0, false, "timespec.tv_nsec", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "timespec.tv_sec"),
            ffunc = s7_make_typed_function_with_environment(sc, "timespec.tv_sec", g_timespec_tv_sec, 1, 0, false, "timespec.tv_sec", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "timespec.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "timespec.make", g_timespec_make, 0, 0, false, "timespec.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_stime"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_stime", g_rusage_ru_stime, 1, 0, false, "rusage.ru_stime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_utime"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_utime", g_rusage_ru_utime, 1, 0, false, "rusage.ru_utime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_nivcsw"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_nivcsw", g_rusage_ru_nivcsw, 1, 0, false, "rusage.ru_nivcsw", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_nvcsw"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_nvcsw", g_rusage_ru_nvcsw, 1, 0, false, "rusage.ru_nvcsw", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_oublock"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_oublock", g_rusage_ru_oublock, 1, 0, false, "rusage.ru_oublock", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_inblock"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_inblock", g_rusage_ru_inblock, 1, 0, false, "rusage.ru_inblock", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_majflt"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_majflt", g_rusage_ru_majflt, 1, 0, false, "rusage.ru_majflt", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_minflt"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_minflt", g_rusage_ru_minflt, 1, 0, false, "rusage.ru_minflt", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.ru_maxrss"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.ru_maxrss", g_rusage_ru_maxrss, 1, 0, false, "rusage.ru_maxrss", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getrusage"),
            ffunc = s7_make_typed_function_with_environment(sc, "getrusage", g_getrusage, 2, 0, false, "getrusage", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rusage.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "rusage.make", g_rusage_make, 0, 0, false, "rusage.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rlimit.rlim_max"),
            ffunc = s7_make_typed_function_with_environment(sc, "rlimit.rlim_max", g_rlimit_rlim_max, 1, 0, false, "rlimit.rlim_max", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rlimit.rlim_cur"),
            ffunc = s7_make_typed_function_with_environment(sc, "rlimit.rlim_cur", g_rlimit_rlim_cur, 1, 0, false, "rlimit.rlim_cur", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rlimit.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "rlimit.make", g_rlimit_make, 0, 0, false, "rlimit.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setpriority"),
            ffunc = s7_make_typed_function_with_environment(sc, "setpriority", s7__setpriority, 3, 0, false, "int setpriority(int int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getpriority"),
            ffunc = s7_make_typed_function_with_environment(sc, "getpriority", s7__getpriority, 2, 0, false, "int getpriority(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigpending"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigpending", s7__sigpending, 1, 0, false, "int sigpending(sigset_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigsuspend"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigsuspend", s7__sigsuspend, 1, 0, false, "int sigsuspend(sigset_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigprocmask"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigprocmask", s7__sigprocmask, 3, 0, false, "int sigprocmask(int sigset_t* sigset_t*)", pcl_iix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigismember"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigismember", s7__sigismember, 2, 0, false, "int sigismember(sigset_t* int)", pl_ixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigdelset"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigdelset", s7__sigdelset, 2, 0, false, "int sigdelset(sigset_t* int)", pl_ixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigaddset"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigaddset", s7__sigaddset, 2, 0, false, "int sigaddset(sigset_t* int)", pl_ixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigfillset"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigfillset", s7__sigfillset, 1, 0, false, "int sigfillset(sigset_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigemptyset"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigemptyset", s7__sigemptyset, 1, 0, false, "int sigemptyset(sigset_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "raise"),
            ffunc = s7_make_typed_function_with_environment(sc, "raise", s7__raise, 1, 0, false, "int raise(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "kill"),
            ffunc = s7_make_typed_function_with_environment(sc, "kill", s7__kill, 2, 0, false, "int kill(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "glob"),
            ffunc = s7_make_typed_function_with_environment(sc, "glob", g_glob, 3, 0, false, "glob", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "glob.gl_pathv"),
            ffunc = s7_make_typed_function_with_environment(sc, "glob.gl_pathv", g_glob_gl_pathv, 1, 0, false, "glob.gl_pathv", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "glob.gl_pathc"),
            ffunc = s7_make_typed_function_with_environment(sc, "glob.gl_pathc", g_glob_gl_pathc, 1, 0, false, "glob.gl_pathc", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "glob.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "glob.make", g_glob_make, 0, 0, false, "glob.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "globfree"),
            ffunc = s7_make_typed_function_with_environment(sc, "globfree", s7__globfree, 1, 0, false, "void globfree(glob_t*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "wordexp.we_wordv"),
            ffunc = s7_make_typed_function_with_environment(sc, "wordexp.we_wordv", g_wordexp_we_wordv, 1, 0, false, "wordexp.we_wordv", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "wordexp.we_wordc"),
            ffunc = s7_make_typed_function_with_environment(sc, "wordexp.we_wordc", g_wordexp_we_wordc, 1, 0, false, "wordexp.we_wordc", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "wordexp.free"),
            ffunc = s7_make_typed_function_with_environment(sc, "wordexp.free", g_wordexp_free, 1, 0, false, "wordexp.free", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "wordexp.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "wordexp.make", g_wordexp_make, 0, 0, false, "wordexp.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "wordfree"),
            ffunc = s7_make_typed_function_with_environment(sc, "wordfree", s7__wordfree, 1, 0, false, "void wordfree(wordexp_t*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "wordexp"),
            ffunc = s7_make_typed_function_with_environment(sc, "wordexp", s7__wordexp, 3, 0, false, "int wordexp(char* wordexp_t* int)", pl_isxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "passwd.pw_shell"),
            ffunc = s7_make_typed_function_with_environment(sc, "passwd.pw_shell", g_passwd_pw_shell, 1, 0, false, "passwd.pw_shell", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "passwd.pw_dir"),
            ffunc = s7_make_typed_function_with_environment(sc, "passwd.pw_dir", g_passwd_pw_dir, 1, 0, false, "passwd.pw_dir", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "passwd.pw_gecos"),
            ffunc = s7_make_typed_function_with_environment(sc, "passwd.pw_gecos", g_passwd_pw_gecos, 1, 0, false, "passwd.pw_gecos", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "passwd.pw_gid"),
            ffunc = s7_make_typed_function_with_environment(sc, "passwd.pw_gid", g_passwd_pw_gid, 1, 0, false, "passwd.pw_gid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "passwd.pw_uid"),
            ffunc = s7_make_typed_function_with_environment(sc, "passwd.pw_uid", g_passwd_pw_uid, 1, 0, false, "passwd.pw_uid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "passwd.pw_passwd"),
            ffunc = s7_make_typed_function_with_environment(sc, "passwd.pw_passwd", g_passwd_pw_passwd, 1, 0, false, "passwd.pw_passwd", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "passwd.pw_name"),
            ffunc = s7_make_typed_function_with_environment(sc, "passwd.pw_name", g_passwd_pw_name, 1, 0, false, "passwd.pw_name", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getpwnam"),
            ffunc = s7_make_typed_function_with_environment(sc, "getpwnam", s7__getpwnam, 1, 0, false, "passwd* getpwnam(char*)", pl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getpwuid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getpwuid", s7__getpwuid, 1, 0, false, "passwd* getpwuid(int)", pl_xi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getpwent"),
            ffunc = s7_make_typed_function_with_environment(sc, "getpwent", s7__getpwent, 0, 0, false, "passwd* getpwent(void)", pl_xt, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "endpwent"),
            ffunc = s7_make_typed_function_with_environment(sc, "endpwent", s7__endpwent, 0, 0, false, "void endpwent(void)", pcl_t, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setpwent"),
            ffunc = s7_make_typed_function_with_environment(sc, "setpwent", s7__setpwent, 0, 0, false, "void setpwent(void)", pcl_t, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "group.gr_mem"),
            ffunc = s7_make_typed_function_with_environment(sc, "group.gr_mem", g_group_gr_mem, 1, 0, false, "group.gr_mem", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "group.gr_gid"),
            ffunc = s7_make_typed_function_with_environment(sc, "group.gr_gid", g_group_gr_gid, 1, 0, false, "group.gr_gid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "group.gr_passwd"),
            ffunc = s7_make_typed_function_with_environment(sc, "group.gr_passwd", g_group_gr_passwd, 1, 0, false, "group.gr_passwd", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "group.gr_name"),
            ffunc = s7_make_typed_function_with_environment(sc, "group.gr_name", g_group_gr_name, 1, 0, false, "group.gr_name", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getgrnam"),
            ffunc = s7_make_typed_function_with_environment(sc, "getgrnam", g_getgrnam, 1, 0, false, "getgrnam", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getgrgid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getgrgid", g_getgrgid, 1, 0, false, "getgrgid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "termios.set_c_cc"),
            ffunc = s7_make_typed_function_with_environment(sc, "termios.set_c_cc", g_termios_set_c_cc, 3, 0, false, "termios.set_c_cc", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "termios.set_c_lflag"),
            ffunc = s7_make_typed_function_with_environment(sc, "termios.set_c_lflag", g_termios_set_c_lflag, 2, 0, false, "termios.set_c_lflag", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "termios.c_lflag"),
            ffunc = s7_make_typed_function_with_environment(sc, "termios.c_lflag", g_termios_c_lflag, 1, 0, false, "termios.c_lflag", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "termios.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "termios.make", g_termios_make, 0, 0, false, "termios.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcsetattr"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcsetattr", g_tcsetattr, 3, 0, false, "tcsetattr", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcgetattr"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcgetattr", g_tcgetattr, 2, 0, false, "tcgetattr", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "cfsetispeed"),
            ffunc = s7_make_typed_function_with_environment(sc, "cfsetispeed", g_cfsetispeed, 2, 0, false, "cfsetispeed", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "cfsetospeed"),
            ffunc = s7_make_typed_function_with_environment(sc, "cfsetospeed", g_cfsetospeed, 2, 0, false, "cfsetospeed", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "cfgetispeed"),
            ffunc = s7_make_typed_function_with_environment(sc, "cfgetispeed", g_cfgetispeed, 1, 0, false, "cfgetispeed", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "cfgetospeed"),
            ffunc = s7_make_typed_function_with_environment(sc, "cfgetospeed", g_cfgetospeed, 1, 0, false, "cfgetospeed", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcflow"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcflow", s7__tcflow, 2, 0, false, "int tcflow(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcflush"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcflush", s7__tcflush, 2, 0, false, "int tcflush(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcdrain"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcdrain", s7__tcdrain, 1, 0, false, "int tcdrain(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcsendbreak"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcsendbreak", s7__tcsendbreak, 2, 0, false, "int tcsendbreak(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "utime"),
            ffunc = s7_make_typed_function_with_environment(sc, "utime", g_utime, 3, 0, false, "utime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "clock_nanosleep"),
            ffunc = s7_make_typed_function_with_environment(sc, "clock_nanosleep", g_clock_nanosleep, 4, 0, false, "clock_nanosleep", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "clock_getcpuclockid"),
            ffunc = s7_make_typed_function_with_environment(sc, "clock_getcpuclockid", g_clock_getcpuclockid, 1, 0, false, "clock_getcpuclockid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "clock_settime"),
            ffunc = s7_make_typed_function_with_environment(sc, "clock_settime", g_clock_settime, 3, 0, false, "clock_settime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "clock_gettime"),
            ffunc = s7_make_typed_function_with_environment(sc, "clock_gettime", g_clock_gettime, 1, 0, false, "clock_gettime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "clock_getres"),
            ffunc = s7_make_typed_function_with_environment(sc, "clock_getres", g_clock_getres, 1, 0, false, "clock_getres", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "nanosleep"),
            ffunc = s7_make_typed_function_with_environment(sc, "nanosleep", g_nanosleep, 2, 0, false, "nanosleep", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "gettimeofday"),
            ffunc = s7_make_typed_function_with_environment(sc, "gettimeofday", g_gettimeofday, 0, 0, false, "gettimeofday", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strftime"),
            ffunc = s7_make_typed_function_with_environment(sc, "strftime", g_strftime, 4, 0, false, "strftime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "mktime"),
            ffunc = s7_make_typed_function_with_environment(sc, "mktime", g_mktime, 1, 0, false, "mktime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "time.free"),
            ffunc = s7_make_typed_function_with_environment(sc, "time.free", g_time_free, 1, 0, false, "time.free", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "time.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "time.make", g_time_make, 1, 0, false, "time.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "localtime"),
            ffunc = s7_make_typed_function_with_environment(sc, "localtime", s7__localtime, 1, 0, false, "tm* localtime(time_t*)", pcl_x, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ctime"),
            ffunc = s7_make_typed_function_with_environment(sc, "ctime", s7__ctime, 1, 0, false, "char* ctime(time_t*)", pl_sx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "gmtime"),
            ffunc = s7_make_typed_function_with_environment(sc, "gmtime", s7__gmtime, 1, 0, false, "tm* gmtime(time_t*)", pcl_x, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "difftime"),
            ffunc = s7_make_typed_function_with_environment(sc, "difftime", s7__difftime, 2, 0, false, "double difftime((time_t integer) (time_t integer))", pcl_di, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "time"),
            ffunc = s7_make_typed_function_with_environment(sc, "time", s7__time, 1, 0, false, "int time(time_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "clock"),
            ffunc = s7_make_typed_function_with_environment(sc, "clock", s7__clock, 0, 0, false, "int clock(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.make", g_stat_make, 0, 0, false, "stat.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.free"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.free", g_stat_free, 1, 0, false, "stat.free", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_ctime"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_ctime", g_st_ctime, 1, 0, false, "stat.st_ctime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_mtime"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_mtime", g_st_mtime, 1, 0, false, "stat.st_mtime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_atime"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_atime", g_st_atime, 1, 0, false, "stat.st_atime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_blocks"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_blocks", g_st_blocks, 1, 0, false, "stat.st_blocks", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_blksize"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_blksize", g_st_blksize, 1, 0, false, "stat.st_blksize", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_size"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_size", g_st_size, 1, 0, false, "stat.st_size", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_rdev"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_rdev", g_st_rdev, 1, 0, false, "stat.st_rdev", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_gid"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_gid", g_st_gid, 1, 0, false, "stat.st_gid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_uid"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_uid", g_st_uid, 1, 0, false, "stat.st_uid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_nlink"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_nlink", g_st_nlink, 1, 0, false, "stat.st_nlink", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_mode"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_mode", g_st_mode, 1, 0, false, "stat.st_mode", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_ino"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_ino", g_st_ino, 1, 0, false, "stat.st_ino", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat.st_dev"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat.st_dev", g_st_dev, 1, 0, false, "stat.st_dev", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "S_ISSOCK"),
            ffunc = s7_make_typed_function_with_environment(sc, "S_ISSOCK", g_issock, 1, 0, false, "S_ISSOCK", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "S_ISLNK"),
            ffunc = s7_make_typed_function_with_environment(sc, "S_ISLNK", g_islnk, 1, 0, false, "S_ISLNK", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "S_ISFIFO"),
            ffunc = s7_make_typed_function_with_environment(sc, "S_ISFIFO", g_isfifo, 1, 0, false, "S_ISFIFO", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "S_ISREG"),
            ffunc = s7_make_typed_function_with_environment(sc, "S_ISREG", g_isreg, 1, 0, false, "S_ISREG", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "S_ISBLK"),
            ffunc = s7_make_typed_function_with_environment(sc, "S_ISBLK", g_isblk, 1, 0, false, "S_ISBLK", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "S_ISCHR"),
            ffunc = s7_make_typed_function_with_environment(sc, "S_ISCHR", g_ischr, 1, 0, false, "S_ISCHR", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "S_ISDIR"),
            ffunc = s7_make_typed_function_with_environment(sc, "S_ISDIR", g_isdir, 1, 0, false, "S_ISDIR", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "mkfifo"),
            ffunc = s7_make_typed_function_with_environment(sc, "mkfifo", s7__mkfifo, 2, 0, false, "int mkfifo(char* int)", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "mknod"),
            ffunc = s7_make_typed_function_with_environment(sc, "mknod", s7__mknod, 3, 0, false, "int mknod(char* int int)", pcl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "mkdir"),
            ffunc = s7_make_typed_function_with_environment(sc, "mkdir", s7__mkdir, 2, 0, false, "int mkdir(char* int)", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "chmod"),
            ffunc = s7_make_typed_function_with_environment(sc, "chmod", s7__chmod, 2, 0, false, "int chmod(char* int)", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "lstat"),
            ffunc = s7_make_typed_function_with_environment(sc, "lstat", g_lstat, 2, 0, false, "lstat", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fstat"),
            ffunc = s7_make_typed_function_with_environment(sc, "fstat", g_fstat, 2, 0, false, "fstat", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "stat"),
            ffunc = s7_make_typed_function_with_environment(sc, "stat", g_stat, 2, 0, false, "stat", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ftw"),
            ffunc = s7_make_typed_function_with_environment(sc, "ftw", g_ftw, 3, 0, false, "ftw", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "read_dir"),
            ffunc = s7_make_typed_function_with_environment(sc, "read_dir", s7__read_dir, 1, 0, false, "char* read_dir(DIR*)", pl_sx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rewinddir"),
            ffunc = s7_make_typed_function_with_environment(sc, "rewinddir", s7__rewinddir, 1, 0, false, "void rewinddir(DIR*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "closedir"),
            ffunc = s7_make_typed_function_with_environment(sc, "closedir", s7__closedir, 1, 0, false, "int closedir(DIR*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "opendir"),
            ffunc = s7_make_typed_function_with_environment(sc, "opendir", s7__opendir, 1, 0, false, "DIR* opendir(char*)", pl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getgroups"),
            ffunc = s7_make_typed_function_with_environment(sc, "getgroups", g_getgroups, 1, 0, false, "getgroups", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getenvs"),
            ffunc = s7_make_typed_function_with_environment(sc, "getenvs", getenvs, 0, 0, false, "(getenvs) returns all the environment variables in an alist", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ftruncate"),
            ffunc = s7_make_typed_function_with_environment(sc, "ftruncate", s7__ftruncate, 2, 0, false, "int ftruncate(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "truncate"),
            ffunc = s7_make_typed_function_with_environment(sc, "truncate", s7__truncate, 2, 0, false, "int truncate(char* int)", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getlogin"),
            ffunc = s7_make_typed_function_with_environment(sc, "getlogin", s7__getlogin, 0, 0, false, "char* getlogin(void)", pl_st, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcsetpgrp"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcsetpgrp", s7__tcsetpgrp, 2, 0, false, "int tcsetpgrp(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tcgetpgrp"),
            ffunc = s7_make_typed_function_with_environment(sc, "tcgetpgrp", s7__tcgetpgrp, 1, 0, false, "int tcgetpgrp(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rmdir"),
            ffunc = s7_make_typed_function_with_environment(sc, "rmdir", s7__rmdir, 1, 0, false, "int rmdir(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "unlink"),
            ffunc = s7_make_typed_function_with_environment(sc, "unlink", s7__unlink, 1, 0, false, "int unlink(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "link"),
            ffunc = s7_make_typed_function_with_environment(sc, "link", s7__link, 2, 0, false, "int link(char* char*)", pcl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isatty"),
            ffunc = s7_make_typed_function_with_environment(sc, "isatty", s7__isatty, 1, 0, false, "int isatty(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ttyname"),
            ffunc = s7_make_typed_function_with_environment(sc, "ttyname", s7__ttyname, 1, 0, false, "char* ttyname(int)", pl_si, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fork"),
            ffunc = s7_make_typed_function_with_environment(sc, "fork", s7__fork, 0, 0, false, "int fork(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setgid"),
            ffunc = s7_make_typed_function_with_environment(sc, "setgid", s7__setgid, 1, 0, false, "int setgid(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setuid"),
            ffunc = s7_make_typed_function_with_environment(sc, "setuid", s7__setuid, 1, 0, false, "int setuid(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getegid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getegid", s7__getegid, 0, 0, false, "int getegid(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getgid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getgid", s7__getgid, 0, 0, false, "int getgid(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "geteuid"),
            ffunc = s7_make_typed_function_with_environment(sc, "geteuid", s7__geteuid, 0, 0, false, "int geteuid(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getuid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getuid", s7__getuid, 0, 0, false, "int getuid(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getsid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getsid", s7__getsid, 1, 0, false, "int getsid(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setsid"),
            ffunc = s7_make_typed_function_with_environment(sc, "setsid", s7__setsid, 0, 0, false, "int setsid(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setpgid"),
            ffunc = s7_make_typed_function_with_environment(sc, "setpgid", s7__setpgid, 2, 0, false, "int setpgid(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getpgid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getpgid", s7__getpgid, 1, 0, false, "int getpgid(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getppid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getppid", s7__getppid, 0, 0, false, "int getppid(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getpid"),
            ffunc = s7_make_typed_function_with_environment(sc, "getpid", s7__getpid, 0, 0, false, "int getpid(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "confstr"),
            ffunc = s7_make_typed_function_with_environment(sc, "confstr", s7__confstr, 3, 0, false, "size_t confstr(int char* size_t)", pl_iisi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sysconf"),
            ffunc = s7_make_typed_function_with_environment(sc, "sysconf", s7__sysconf, 1, 0, false, "int sysconf(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fpathconf"),
            ffunc = s7_make_typed_function_with_environment(sc, "fpathconf", s7__fpathconf, 2, 0, false, "int fpathconf(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "pathconf"),
            ffunc = s7_make_typed_function_with_environment(sc, "pathconf", s7__pathconf, 2, 0, false, "int pathconf(char* int)", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "_exit"),
            ffunc = s7_make_typed_function_with_environment(sc, "_exit", s7___exit, 1, 0, false, "void _exit(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "dup2"),
            ffunc = s7_make_typed_function_with_environment(sc, "dup2", s7__dup2, 2, 0, false, "int dup2(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "dup"),
            ffunc = s7_make_typed_function_with_environment(sc, "dup", s7__dup, 1, 0, false, "int dup(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getcwd"),
            ffunc = s7_make_typed_function_with_environment(sc, "getcwd", s7__getcwd, 2, 0, false, "char* getcwd(char* size_t)", pl_ssi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "chdir"),
            ffunc = s7_make_typed_function_with_environment(sc, "chdir", s7__chdir, 1, 0, false, "int chdir(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "chown"),
            ffunc = s7_make_typed_function_with_environment(sc, "chown", s7__chown, 3, 0, false, "int chown(char* int int)", pcl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "pause"),
            ffunc = s7_make_typed_function_with_environment(sc, "pause", s7__pause, 0, 0, false, "int pause(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sleep"),
            ffunc = s7_make_typed_function_with_environment(sc, "sleep", s7__sleep, 1, 0, false, "int sleep(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "alarm"),
            ffunc = s7_make_typed_function_with_environment(sc, "alarm", s7__alarm, 1, 0, false, "int alarm(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "pipe"),
            ffunc = s7_make_typed_function_with_environment(sc, "pipe", s7__pipe, 1, 0, false, "int pipe(int*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "pwrite"),
            ffunc = s7_make_typed_function_with_environment(sc, "pwrite", s7__pwrite, 4, 0, false, "ssize_t pwrite(int void* size_t int)", pcl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "pread"),
            ffunc = s7_make_typed_function_with_environment(sc, "pread", s7__pread, 4, 0, false, "ssize_t pread(int void* size_t int)", pcl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "write"),
            ffunc = s7_make_typed_function_with_environment(sc, "write", s7__write, 3, 0, false, "ssize_t write(int void* size_t)", pl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "read"),
            ffunc = s7_make_typed_function_with_environment(sc, "read", s7__read, 3, 0, false, "ssize_t read(int void* size_t)", pl_iixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "close"),
            ffunc = s7_make_typed_function_with_environment(sc, "close", s7__close, 1, 0, false, "int close(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "lseek"),
            ffunc = s7_make_typed_function_with_environment(sc, "lseek", s7__lseek, 3, 0, false, "int lseek(int int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "access"),
            ffunc = s7_make_typed_function_with_environment(sc, "access", s7__access, 2, 0, false, "int access(char* int)", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "uname"),
            ffunc = s7_make_typed_function_with_environment(sc, "uname", g_uname, 0, 0, false, "uname", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "localeconv"),
            ffunc = s7_make_typed_function_with_environment(sc, "localeconv", g_localeconv, 0, 0, false, "localeconv", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setlocale"),
            ffunc = s7_make_typed_function_with_environment(sc, "setlocale", s7__setlocale, 2, 0, false, "char* setlocale(int char*)", pl_sis, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "set_errno"),
            ffunc = s7_make_typed_function_with_environment(sc, "set_errno", g_set_errno, 1, 0, false, "set_errno", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "errno"),
            ffunc = s7_make_typed_function_with_environment(sc, "errno", g_errno, 0, 0, false, "errno", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "realpath"),
            ffunc = s7_make_typed_function_with_environment(sc, "realpath", g_realpath, 2, 0, false, "realpath", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ldiv"),
            ffunc = s7_make_typed_function_with_environment(sc, "ldiv", g_ldiv, 2, 0, false, "ldiv", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "div"),
            ffunc = s7_make_typed_function_with_environment(sc, "div", g_ldiv, 2, 0, false, "div", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strtoll"),
            ffunc = s7_make_typed_function_with_environment(sc, "strtoll", g_strtoll, 2, 0, false, "strtoll", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strtol"),
            ffunc = s7_make_typed_function_with_environment(sc, "strtol", g_strtol, 2, 0, false, "strtol", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strtof"),
            ffunc = s7_make_typed_function_with_environment(sc, "strtof", g_strtof, 1, 0, false, "strtof", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strtod"),
            ffunc = s7_make_typed_function_with_environment(sc, "strtod", g_strtod, 1, 0, false, "strtod", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "free"),
            ffunc = s7_make_typed_function_with_environment(sc, "free", g_free, 1, 0, false, "free", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "llabs"),
            ffunc = s7_make_typed_function_with_environment(sc, "llabs", g_llabs, 1, 0, false, "llabs", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "labs"),
            ffunc = s7_make_typed_function_with_environment(sc, "labs", s7__labs, 1, 0, false, "int labs(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "abs"),
            ffunc = s7_make_typed_function_with_environment(sc, "abs", s7__abs, 1, 0, false, "int abs(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "system"),
            ffunc = s7_make_typed_function_with_environment(sc, "system", s7__system, 1, 0, false, "int system(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "mkstemp"),
            ffunc = s7_make_typed_function_with_environment(sc, "mkstemp", s7__mkstemp, 1, 0, false, "int mkstemp(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "unsetenv"),
            ffunc = s7_make_typed_function_with_environment(sc, "unsetenv", s7__unsetenv, 1, 0, false, "int unsetenv(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setenv"),
            ffunc = s7_make_typed_function_with_environment(sc, "setenv", s7__setenv, 3, 0, false, "int setenv(char* char* int)", pl_issi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "putenv"),
            ffunc = s7_make_typed_function_with_environment(sc, "putenv", s7__putenv, 1, 0, false, "int putenv(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getenv"),
            ffunc = s7_make_typed_function_with_environment(sc, "getenv", s7__getenv, 1, 0, false, "char* getenv(char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "exit"),
            ffunc = s7_make_typed_function_with_environment(sc, "exit", s7__exit, 1, 0, false, "void exit(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "abort"),
            ffunc = s7_make_typed_function_with_environment(sc, "abort", s7__abort, 0, 0, false, "void abort(void)", pcl_t, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "realloc"),
            ffunc = s7_make_typed_function_with_environment(sc, "realloc", s7__realloc, 2, 0, false, "void* realloc(void* size_t)", pl_xxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "calloc"),
            ffunc = s7_make_typed_function_with_environment(sc, "calloc", s7__calloc, 2, 0, false, "void* calloc(size_t size_t)", pcl_xi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "malloc"),
            ffunc = s7_make_typed_function_with_environment(sc, "malloc", s7__malloc, 1, 0, false, "void* malloc(size_t)", pl_xi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "srand"),
            ffunc = s7_make_typed_function_with_environment(sc, "srand", s7__srand, 1, 0, false, "void srand(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rand"),
            ffunc = s7_make_typed_function_with_environment(sc, "rand", s7__rand, 0, 0, false, "int rand(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setstate"),
            ffunc = s7_make_typed_function_with_environment(sc, "setstate", s7__setstate, 1, 0, false, "char* setstate(char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "initstate"),
            ffunc = s7_make_typed_function_with_environment(sc, "initstate", s7__initstate, 3, 0, false, "char* initstate(int char* size_t)", pl_sisi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "srandom"),
            ffunc = s7_make_typed_function_with_environment(sc, "srandom", s7__srandom, 1, 0, false, "void srandom(int)", pl_ti, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "random"),
            ffunc = s7_make_typed_function_with_environment(sc, "random", s7__random, 0, 0, false, "int random(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "atoll"),
            ffunc = s7_make_typed_function_with_environment(sc, "atoll", s7__atoll, 1, 0, false, "int atoll(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "atol"),
            ffunc = s7_make_typed_function_with_environment(sc, "atol", s7__atol, 1, 0, false, "int atol(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "atoi"),
            ffunc = s7_make_typed_function_with_environment(sc, "atoi", s7__atoi, 1, 0, false, "int atoi(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "atof"),
            ffunc = s7_make_typed_function_with_environment(sc, "atof", s7__atof, 1, 0, false, "double atof(char*)", pl_ds, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "funlockfile"),
            ffunc = s7_make_typed_function_with_environment(sc, "funlockfile", s7__funlockfile, 1, 0, false, "void funlockfile(FILE*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ftrylockfile"),
            ffunc = s7_make_typed_function_with_environment(sc, "ftrylockfile", s7__ftrylockfile, 1, 0, false, "int ftrylockfile(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "flockfile"),
            ffunc = s7_make_typed_function_with_environment(sc, "flockfile", s7__flockfile, 1, 0, false, "void flockfile(FILE*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ctermid"),
            ffunc = s7_make_typed_function_with_environment(sc, "ctermid", s7__ctermid, 1, 0, false, "char* ctermid(char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "pclose"),
            ffunc = s7_make_typed_function_with_environment(sc, "pclose", s7__pclose, 1, 0, false, "int pclose(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "popen"),
            ffunc = s7_make_typed_function_with_environment(sc, "popen", s7__popen, 2, 0, false, "FILE* popen(char* char*)", pcl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fileno"),
            ffunc = s7_make_typed_function_with_environment(sc, "fileno", s7__fileno, 1, 0, false, "int fileno(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "perror"),
            ffunc = s7_make_typed_function_with_environment(sc, "perror", s7__perror, 1, 0, false, "void perror(char*)", pl_ts, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ferror"),
            ffunc = s7_make_typed_function_with_environment(sc, "ferror", s7__ferror, 1, 0, false, "int ferror(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "feof"),
            ffunc = s7_make_typed_function_with_environment(sc, "feof", s7__feof, 1, 0, false, "int feof(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "clearerr"),
            ffunc = s7_make_typed_function_with_environment(sc, "clearerr", s7__clearerr, 1, 0, false, "void clearerr(FILE*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fsetpos"),
            ffunc = s7_make_typed_function_with_environment(sc, "fsetpos", s7__fsetpos, 2, 0, false, "int fsetpos(FILE* fpos_t*)", pcl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fgetpos"),
            ffunc = s7_make_typed_function_with_environment(sc, "fgetpos", s7__fgetpos, 2, 0, false, "int fgetpos(FILE* fpos_t*)", pcl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rewind"),
            ffunc = s7_make_typed_function_with_environment(sc, "rewind", s7__rewind, 1, 0, false, "void rewind(FILE*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ftell"),
            ffunc = s7_make_typed_function_with_environment(sc, "ftell", s7__ftell, 1, 0, false, "int ftell(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fseek"),
            ffunc = s7_make_typed_function_with_environment(sc, "fseek", s7__fseek, 3, 0, false, "int fseek(FILE* int int)", pcl_ixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fwrite"),
            ffunc = s7_make_typed_function_with_environment(sc, "fwrite", s7__fwrite, 4, 0, false, "size_t fwrite(void* size_t size_t FILE*)", pl_ixiix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fread"),
            ffunc = s7_make_typed_function_with_environment(sc, "fread", s7__fread, 4, 0, false, "size_t fread(void* size_t size_t FILE*)", pl_ixiix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ungetc"),
            ffunc = s7_make_typed_function_with_environment(sc, "ungetc", s7__ungetc, 2, 0, false, "int ungetc(int FILE*)", pl_iix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "puts"),
            ffunc = s7_make_typed_function_with_environment(sc, "puts", s7__puts, 1, 0, false, "int puts(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fputs"),
            ffunc = s7_make_typed_function_with_environment(sc, "fputs", s7__fputs, 2, 0, false, "int fputs(char* FILE*)", pl_isx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fgets"),
            ffunc = s7_make_typed_function_with_environment(sc, "fgets", s7__fgets, 3, 0, false, "char* fgets(char* int FILE*)", pl_ssix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "putchar"),
            ffunc = s7_make_typed_function_with_environment(sc, "putchar", s7__putchar, 1, 0, false, "int putchar(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "putc"),
            ffunc = s7_make_typed_function_with_environment(sc, "putc", s7__putc, 2, 0, false, "int putc(int FILE*)", pl_iix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fputc"),
            ffunc = s7_make_typed_function_with_environment(sc, "fputc", s7__fputc, 2, 0, false, "int fputc(int FILE*)", pl_iix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getchar"),
            ffunc = s7_make_typed_function_with_environment(sc, "getchar", s7__getchar, 0, 0, false, "int getchar(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "getc"),
            ffunc = s7_make_typed_function_with_environment(sc, "getc", s7__getc, 1, 0, false, "int getc(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fgetc"),
            ffunc = s7_make_typed_function_with_environment(sc, "fgetc", s7__fgetc, 1, 0, false, "int fgetc(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setlinebuf"),
            ffunc = s7_make_typed_function_with_environment(sc, "setlinebuf", s7__setlinebuf, 1, 0, false, "void setlinebuf(FILE*)", pl_tx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setvbuf"),
            ffunc = s7_make_typed_function_with_environment(sc, "setvbuf", s7__setvbuf, 4, 0, false, "int setvbuf(FILE* char* int size_t)", pcl_ixsi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "setbuf"),
            ffunc = s7_make_typed_function_with_environment(sc, "setbuf", s7__setbuf, 2, 0, false, "void setbuf(FILE* char*)", pl_txs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fdopen"),
            ffunc = s7_make_typed_function_with_environment(sc, "fdopen", s7__fdopen, 2, 0, false, "FILE* fdopen(int char*)", pl_xis, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "freopen"),
            ffunc = s7_make_typed_function_with_environment(sc, "freopen", s7__freopen, 3, 0, false, "FILE* freopen(char* char* FILE*)", pl_xssx, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fopen"),
            ffunc = s7_make_typed_function_with_environment(sc, "fopen", s7__fopen, 2, 0, false, "FILE* fopen(char* char*)", pcl_xs, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fflush"),
            ffunc = s7_make_typed_function_with_environment(sc, "fflush", s7__fflush, 1, 0, false, "int fflush(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fclose"),
            ffunc = s7_make_typed_function_with_environment(sc, "fclose", s7__fclose, 1, 0, false, "int fclose(FILE*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tmpfile"),
            ffunc = s7_make_typed_function_with_environment(sc, "tmpfile", s7__tmpfile, 0, 0, false, "FILE* tmpfile(void)", pl_xt, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "rename"),
            ffunc = s7_make_typed_function_with_environment(sc, "rename", s7__rename, 2, 0, false, "int rename(char* char*)", pcl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "remove"),
            ffunc = s7_make_typed_function_with_environment(sc, "remove", s7__remove, 1, 0, false, "int remove(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strncasecmp"),
            ffunc = s7_make_typed_function_with_environment(sc, "strncasecmp", s7__strncasecmp, 3, 0, false, "int strncasecmp(char* char* size_t)", pl_issi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strcasecmp"),
            ffunc = s7_make_typed_function_with_environment(sc, "strcasecmp", s7__strcasecmp, 2, 0, false, "int strcasecmp(char* char*)", pcl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strerror"),
            ffunc = s7_make_typed_function_with_environment(sc, "strerror", s7__strerror, 1, 0, false, "char* strerror(int)", pl_si, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strnlen"),
            ffunc = s7_make_typed_function_with_environment(sc, "strnlen", s7__strnlen, 2, 0, false, "size_t strnlen(char* size_t)", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strlen"),
            ffunc = s7_make_typed_function_with_environment(sc, "strlen", s7__strlen, 1, 0, false, "size_t strlen(char*)", pl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strtok"),
            ffunc = s7_make_typed_function_with_environment(sc, "strtok", s7__strtok, 2, 0, false, "char* strtok(char* char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strstr"),
            ffunc = s7_make_typed_function_with_environment(sc, "strstr", s7__strstr, 2, 0, false, "char* strstr(char* char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strpbrk"),
            ffunc = s7_make_typed_function_with_environment(sc, "strpbrk", s7__strpbrk, 2, 0, false, "char* strpbrk(char* char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strspn"),
            ffunc = s7_make_typed_function_with_environment(sc, "strspn", s7__strspn, 2, 0, false, "size_t strspn(char* char*)", pcl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strcspn"),
            ffunc = s7_make_typed_function_with_environment(sc, "strcspn", s7__strcspn, 2, 0, false, "size_t strcspn(char* char*)", pcl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strrchr"),
            ffunc = s7_make_typed_function_with_environment(sc, "strrchr", s7__strrchr, 2, 0, false, "char* strrchr(char* int)", pl_ssi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strchr"),
            ffunc = s7_make_typed_function_with_environment(sc, "strchr", s7__strchr, 2, 0, false, "char* strchr(char* int)", pl_ssi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strxfrm"),
            ffunc = s7_make_typed_function_with_environment(sc, "strxfrm", s7__strxfrm, 3, 0, false, "size_t strxfrm(char* char* size_t)", pl_issi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strcoll"),
            ffunc = s7_make_typed_function_with_environment(sc, "strcoll", s7__strcoll, 2, 0, false, "int strcoll(char* char*)", pcl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strncmp"),
            ffunc = s7_make_typed_function_with_environment(sc, "strncmp", s7__strncmp, 3, 0, false, "int strncmp(char* char* size_t)", pl_issi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strcmp"),
            ffunc = s7_make_typed_function_with_environment(sc, "strcmp", s7__strcmp, 2, 0, false, "int strcmp(char* char*)", pcl_is, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strncat"),
            ffunc = s7_make_typed_function_with_environment(sc, "strncat", s7__strncat, 3, 0, false, "char* strncat(char* char* size_t)", pl_sssi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strcat"),
            ffunc = s7_make_typed_function_with_environment(sc, "strcat", s7__strcat, 2, 0, false, "char* strcat(char* char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strncpy"),
            ffunc = s7_make_typed_function_with_environment(sc, "strncpy", s7__strncpy, 3, 0, false, "char* strncpy(char* char* size_t)", pl_sssi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "strcpy"),
            ffunc = s7_make_typed_function_with_environment(sc, "strcpy", s7__strcpy, 2, 0, false, "char* strcpy(char* char*)", pcl_s, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "memchr"),
            ffunc = s7_make_typed_function_with_environment(sc, "memchr", s7__memchr, 3, 0, false, "void* memchr(void* int size_t)", pcl_xxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "memcmp"),
            ffunc = s7_make_typed_function_with_environment(sc, "memcmp", s7__memcmp, 3, 0, false, "int memcmp(void* void* size_t)", pl_ixxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "memset"),
            ffunc = s7_make_typed_function_with_environment(sc, "memset", s7__memset, 3, 0, false, "void* memset(void* int size_t)", pcl_xxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "memmove"),
            ffunc = s7_make_typed_function_with_environment(sc, "memmove", s7__memmove, 3, 0, false, "void* memmove(void* void* size_t)", pl_xxxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "memcpy"),
            ffunc = s7_make_typed_function_with_environment(sc, "memcpy", s7__memcpy, 3, 0, false, "void* memcpy(void* void* size_t)", pl_xxxi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fnmatch"),
            ffunc = s7_make_typed_function_with_environment(sc, "fnmatch", s7__fnmatch, 3, 0, false, "int fnmatch(char* char* int)", pl_issi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fenv_t.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "fenv_t.make", g_fenv_t_make, 0, 0, false, "fenv_t.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "feupdateenv"),
            ffunc = s7_make_typed_function_with_environment(sc, "feupdateenv", s7__feupdateenv, 1, 0, false, "int feupdateenv(fenv_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fesetenv"),
            ffunc = s7_make_typed_function_with_environment(sc, "fesetenv", s7__fesetenv, 1, 0, false, "int fesetenv(fenv_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "feholdexcept"),
            ffunc = s7_make_typed_function_with_environment(sc, "feholdexcept", s7__feholdexcept, 1, 0, false, "int feholdexcept(fenv_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fegetenv"),
            ffunc = s7_make_typed_function_with_environment(sc, "fegetenv", s7__fegetenv, 1, 0, false, "int fegetenv(fenv_t*)", pl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fesetround"),
            ffunc = s7_make_typed_function_with_environment(sc, "fesetround", s7__fesetround, 1, 0, false, "int fesetround(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fegetround"),
            ffunc = s7_make_typed_function_with_environment(sc, "fegetround", s7__fegetround, 0, 0, false, "int fegetround(void)", pl_it, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fetestexcept"),
            ffunc = s7_make_typed_function_with_environment(sc, "fetestexcept", s7__fetestexcept, 1, 0, false, "int fetestexcept(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fesetexceptflag"),
            ffunc = s7_make_typed_function_with_environment(sc, "fesetexceptflag", s7__fesetexceptflag, 2, 0, false, "int fesetexceptflag(fexcept_t* int)", pl_ixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "feraiseexcept"),
            ffunc = s7_make_typed_function_with_environment(sc, "feraiseexcept", s7__feraiseexcept, 1, 0, false, "int feraiseexcept(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fegetexceptflag"),
            ffunc = s7_make_typed_function_with_environment(sc, "fegetexceptflag", s7__fegetexceptflag, 2, 0, false, "int fegetexceptflag(fexcept_t* int)", pl_ixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "feclearexcept"),
            ffunc = s7_make_typed_function_with_environment(sc, "feclearexcept", s7__feclearexcept, 1, 0, false, "int feclearexcept(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "lockf"),
            ffunc = s7_make_typed_function_with_environment(sc, "lockf", s7__lockf, 3, 0, false, "int lockf(int int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "creat"),
            ffunc = s7_make_typed_function_with_environment(sc, "creat", s7__creat, 2, 0, false, "int creat(char* (mode_t int))", pl_isi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "open"),
            ffunc = s7_make_typed_function_with_environment(sc, "open", g_c_open, 2, 1, false, "open", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "fcntl"),
            ffunc = s7_make_typed_function_with_environment(sc, "fcntl", s7__fcntl, 2, 0, false, "int fcntl(int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "toupper"),
            ffunc = s7_make_typed_function_with_environment(sc, "toupper", s7__toupper, 1, 0, false, "int toupper(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "tolower"),
            ffunc = s7_make_typed_function_with_environment(sc, "tolower", s7__tolower, 1, 0, false, "int tolower(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isxdigit"),
            ffunc = s7_make_typed_function_with_environment(sc, "isxdigit", s7__isxdigit, 1, 0, false, "int isxdigit(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isupper"),
            ffunc = s7_make_typed_function_with_environment(sc, "isupper", s7__isupper, 1, 0, false, "int isupper(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isspace"),
            ffunc = s7_make_typed_function_with_environment(sc, "isspace", s7__isspace, 1, 0, false, "int isspace(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "ispunct"),
            ffunc = s7_make_typed_function_with_environment(sc, "ispunct", s7__ispunct, 1, 0, false, "int ispunct(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isprint"),
            ffunc = s7_make_typed_function_with_environment(sc, "isprint", s7__isprint, 1, 0, false, "int isprint(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isgraph"),
            ffunc = s7_make_typed_function_with_environment(sc, "isgraph", s7__isgraph, 1, 0, false, "int isgraph(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "islower"),
            ffunc = s7_make_typed_function_with_environment(sc, "islower", s7__islower, 1, 0, false, "int islower(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isdigit"),
            ffunc = s7_make_typed_function_with_environment(sc, "isdigit", s7__isdigit, 1, 0, false, "int isdigit(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "iscntrl"),
            ffunc = s7_make_typed_function_with_environment(sc, "iscntrl", s7__iscntrl, 1, 0, false, "int iscntrl(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isalpha"),
            ffunc = s7_make_typed_function_with_environment(sc, "isalpha", s7__isalpha, 1, 0, false, "int isalpha(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "isalnum"),
            ffunc = s7_make_typed_function_with_environment(sc, "isalnum", s7__isalnum, 1, 0, false, "int isalnum(int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "string->c-pointer"),
            ffunc = s7_make_typed_function_with_environment(sc, "string->c-pointer", g_string_to_c_pointer, 1, 0, false, "string->c-pointer", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "c-pointer->string"),
            ffunc = s7_make_typed_function_with_environment(sc, "c-pointer->string", g_c_pointer_to_string, 2, 0, false, "c-pointer->string", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);
